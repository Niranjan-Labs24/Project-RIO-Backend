...
// RIO MFA — never exercised by the existing login/signup fixtures, so a
// bare stub (never called) is enough for the constructor's widened arity,
// same reasoning as repoStub/mailerStub above.
const smsStub = { sendLoginOtpCode: vi.fn() };
...
describe('AuthService.login', () => {
  ...
  it('returns a SessionContext with token, user, org and role on valid credentials', async () => {
    const svc = new AuthService(fakeTenant(user) as never, passwords, tokens, auditStub as never, repoStub as never, mailerStub as never, configStub, domainsStub as never, geographyStub as never, nicRegistryStub as never, consentStub as never, permissionGrantsStub as never, smsStub as never);
  ...
  it('refuses valid credentials when the org is deactivated (403 ORG_INACTIVE)', async () => {
    ...
    const svc = new AuthService(fakeTenant(inactive) as never, passwords, tokens, auditStub as never, repoStub as never, mailerStub as never, configStub, domainsStub as never, geographyStub as never, nicRegistryStub as never, consentStub as never, permissionGrantsStub as never, smsStub as never);
...
describe('AuthService.consent', () => {
  ...
  it('records a separate audit event per consent kind', async () => {
    ...
    const svc = new AuthService(tenant as never, passwords, tokens, audit as never, repoStub as never, mailerStub as never, configStub, domainsStub as never, geographyStub as never, nicRegistryStub as never, consentStub as never, permissionGrantsStub as never, smsStub as never);
...
describe('AuthService.signup', () => {
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new AuthService(tenant as never, passwords as never, tokens as never, audit as never, repo as never, mailer as never, config, domainsStub as never, geographyStub as never, nicRegistryStub as never, consentStub as never, permissionGrantsStub as never, smsStub as never);
  });
...
describe('AuthService.changePassword', () => {
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    service = new AuthService(tenant as never, passwords as never, tokens, audit as never, repo as never, mailer as never, config, domainsStub as never, geographyStub as never, nicRegistryStub as never, consentStub as never, permissionGrantsStub as never, smsStub as never);
  });
...
describe('AuthService.forgotPassword', () => {
  ...
  it('resolves for a known user even though the mailer send never resolves (email is not awaited)', async () => {
    ...
    const service = new AuthService(tenant as never, passwords, tokens, audit as never, repo as never, mailer as never, config, domainsStub as never, geographyStub as never, nicRegistryStub as never, consentStub as never, permissionGrantsStub as never, smsStub as never);
  ...
  it('returns the identical generic message for both known and unknown users', async () => {
    ...
    const knownSvc = new AuthService(known.tenant as never, passwords, tokens, audit as never, repo as never, mailer as never, config, domainsStub as never, geographyStub as never, nicRegistryStub as never, consentStub as never, permissionGrantsStub as never, smsStub as never);
    const unknownSvc = new AuthService(unknown.tenant as never, passwords, tokens, audit as never, repo as never, mailer as never, config, domainsStub as never, geographyStub as never, nicRegistryStub as never, consentStub as never, permissionGrantsStub as never, smsStub as never);
