...
describe('OrganizationsService', () => {
  it('getCurrent maps a row to Organization with an ISO createdAt', async () => {
    const svc = new OrganizationsService(fakeTenant(baseRow) as never, { record: async () => {} } as never, {} as never, domainsStub as never);
  ...
  it('updateCurrent computes changes and records an edit audit event', async () => {
    ...
    const svc = new OrganizationsService(fakeTenant(baseRow) as never, audit as never, {} as never, domainsStub as never);
